...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        max_area_cls = None  # to keep track of the class of the largest detection
        max_area_box = None  # to keep track of the coordinates of the largest detection
